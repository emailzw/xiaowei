...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.section == 0 && indexPath.row==0){
        ...
        lbl.text = @"　　本应用是在上海银监局指导下，由上海市银行同业公会设计开发的一款立足于服务小微企业的公益性平台，共汇集了67家中外资商业银行的370多款服务小微企业的特色金融产品。本应用的发布将增进银企信息对接、提高银行业服务小微企业信贷产品信息的便捷性。\n　　您可直接登录平台，通过填写贷款金额、贷款期限、担保方式等信息，精确查找到符合自身需求的信贷产品。同时，平台以通俗易懂的文字向用户描述各产品的审批标准、审批时限、产品特点、担保方式等内容。同时，企业还能通过比较分析功能同一时间对比多个产品，并通过电话、在线留言等方式与银行取得联系。\n ";
